workspace bbnavi_datahub_deployment {
  model {
     bbnavi_datahub = softwareSystem bbnavi_datahub {
      bbnavi_datahub_stack = container "bbnavi Datahub Stack"
    ...
    github_actions -> bbnavi_datahub_stack "creates/updates"
    github_actions -> image_registry "builds and pushes new images"
    bbnavi_datahub_stack -> image_registry "pulls images"
    ...
    deploymentEnvironment "Live" {
      ...
      deploymentNode "Planetary Networks" "" "tpwd-bb-navi.customer.planetary-quantum.net" "" {
        deploymentNode "Swarm Worker" "Docker" "" "" {
          containerInstance bbnavi_datahub_stack "bbnavi Datahub"
        }
      }
